...
#
$conf['rrdtool'] = "/omd/sites/site01/bin/rrdtool";
#
...
#
$conf['rrdbase'] = "/omd/sites/site01/var/pnp4nagios/perfdata/";
#
# Location of "page" configs
#
$conf['page_dir'] = "/omd/sites/site01/etc/pnp4nagios/pages/";
#
...
# 
$conf['livestatus_socket'] = "unix:/omd/sites/site01/tmp/run/live";
...
#
$conf['background_pdf'] = '/omd/sites/site01/etc/pnp4nagios/background.pdf' ;
#
# Enable Calendar
#
$conf['use_calendar'] = 1;
...
$conf['RRD_DAEMON_OPTS'] = 'unix:/omd/sites/site01/tmp/run/rrdcached.sock';
...
# First match wins!
$conf['template_dirs'][] = '/omd/sites/site01/etc/pnp4nagios/templates';
$conf['template_dirs'][] = '/omd/sites/site01/local/share/check_mk/pnp-templates'; 
$conf['template_dirs'][] = '/omd/sites/site01/share/check_mk/pnp-templates';
$conf['template_dirs'][] = '/omd/sites/site01/share/pnp4nagios/htdocs/templates';
$conf['template_dirs'][] = '/omd/sites/site01/share/pnp4nagios/htdocs/templates.dist';

#
# Directory to search for special templates
#
$conf['special_template_dir'] = '/omd/sites/site01/etc/pnp4nagios/templates.special';
